...
{
	/** 
	 Initializes a new instance of the {@link SinglePartitionKeyServerBatchRequest} class.
...
//ORIGINAL LINE: base(maxBodyLength: int.MaxValue, maxOperationCount: int.MaxValue, serializerCore: serializerCore);
	...
	*/
	...
	/** 
	 Creates an instance of {@link SinglePartitionKeyServerBatchRequest}.
...
//ORIGINAL LINE: public static async Task<SinglePartitionKeyServerBatchRequest> CreateAsync(Nullable<PartitionKey> partitionKey, ArraySegment<ItemBatchOperation> operations, CosmosSerializerCore serializerCore, CancellationToken cancellationToken)
	public static Task<SinglePartitionKeyServerBatchRequest> CreateAsync(PartitionKey partitionKey, ArraySegment<ItemBatchOperation> operations, CosmosSerializerCore serializerCore, CancellationToken cancellationToken)
	{
