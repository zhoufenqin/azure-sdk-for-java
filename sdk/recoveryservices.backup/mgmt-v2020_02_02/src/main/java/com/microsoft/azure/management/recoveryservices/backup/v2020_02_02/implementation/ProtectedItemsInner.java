...
public class ProtectedItemsInner {
    ...
    interface ProtectedItemsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservices.backup.v2020_02_02.ProtectedItems get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservices.backup.v2020_02_02.ProtectedItems createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservices.backup.v2020_02_02.ProtectedItems delete" })
    ...
    public Observable<ServiceResponse<ProtectedItemResourceInner>> getWithServiceResponseAsync(String vaultName, String resourceGroupName, String fabricName, String containerName, String protectedItemName) {
        ...
        return service.get(vaultName, resourceGroupName, this.client.subscriptionId(), fabricName, containerName, protectedItemName, apiVersion, filter, this.client.acceptLanguage(), this.client.userAgent())
     ...
     * @return the ProtectedItemResourceInner object if successful.
     */
    public ProtectedItemResourceInner createOrUpdate(String vaultName, String resourceGroupName, String fabricName, String containerName, String protectedItemName, ProtectedItemResourceInner parameters) {
        return createOrUpdateWithServiceResponseAsync(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, parameters).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ProtectedItemResourceInner> createOrUpdateAsync(String vaultName, String resourceGroupName, String fabricName, String containerName, String protectedItemName, ProtectedItemResourceInner parameters, final ServiceCallback<ProtectedItemResourceInner> serviceCallback) {
     ...
     * @return the observable to the ProtectedItemResourceInner object
     */
    public Observable<ProtectedItemResourceInner> createOrUpdateAsync(String vaultName, String resourceGroupName, String fabricName, String containerName, String protectedItemName, ProtectedItemResourceInner parameters) {
        return createOrUpdateWithServiceResponseAsync(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, parameters).map(new Func1<ServiceResponse<ProtectedItemResourceInner>, ProtectedItemResourceInner>() {
            @Override
            public ProtectedItemResourceInner call(ServiceResponse<ProtectedItemResourceInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the ProtectedItemResourceInner object
     */
    public Observable<ServiceResponse<ProtectedItemResourceInner>> createOrUpdateWithServiceResponseAsync(String vaultName, String resourceGroupName, String fabricName, String containerName, String protectedItemName, ProtectedItemResourceInner parameters) {
        if (vaultName == null) {
            throw new IllegalArgumentException("Parameter vaultName is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        final String apiVersion = "2019-06-15";
        return service.createOrUpdate(vaultName, resourceGroupName, this.client.subscriptionId(), fabricName, containerName, protectedItemName, apiVersion, parameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ProtectedItemResourceInner>>>() {
                @Override
                public Observable<ServiceResponse<ProtectedItemResourceInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<ProtectedItemResourceInner> clientResponse = createOrUpdateDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<ProtectedItemResourceInner> createOrUpdateDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ProtectedItemResourceInner, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<ProtectedItemResourceInner>() { }.getType())
    ...
    public Observable<ServiceResponse<Void>> deleteWithServiceResponseAsync(String vaultName, String resourceGroupName, String fabricName, String containerName, String protectedItemName) {
        ...
        final String apiVersion = "2019-06-15";
        return service.delete(vaultName, resourceGroupName, this.client.subscriptionId(), fabricName, containerName, protectedItemName, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
