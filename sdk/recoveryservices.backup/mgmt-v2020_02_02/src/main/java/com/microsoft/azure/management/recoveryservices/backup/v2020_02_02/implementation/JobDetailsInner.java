...
public class JobDetailsInner {
    ...
    interface JobDetailsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.recoveryservices.backup.v2020_02_02.JobDetails get" })
    ...
    public Observable<ServiceResponse<JobResourceInner>> getWithServiceResponseAsync(String vaultName, String resourceGroupName, String jobName) {
        ...
        return service.get(vaultName, resourceGroupName, this.client.subscriptionId(), jobName, apiVersion, this.client.acceptLanguage(), this.client.userAgent())
