 ...
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "jobType", defaultImpl = JobInner.class)
@JsonTypeName("Job")
@JsonSubTypes({
...
public class JobInner {
    ...
    /**
     * Backup management type to execute the current job. Possible values
    ...
    /**
     * Get friendly name of the entity on which the current job is executing.
     *
    ...
    /**
     * Set friendly name of the entity on which the current job is executing.
     *
    ...
    /**
     * Get backup management type to execute the current job. Possible values include: 'Invalid', 'AzureIaasVM', 'MAB', 'DPM', 'AzureBackupServer', 'AzureSql', 'AzureStorage', 'AzureWorkload', 'DefaultBackup'.
     *
    ...
    /**
     * Set backup management type to execute the current job. Possible values include: 'Invalid', 'AzureIaasVM', 'MAB', 'DPM', 'AzureBackupServer', 'AzureSql', 'AzureStorage', 'AzureWorkload', 'DefaultBackup'.
     *
