 ...
 * this class.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "protectableItemType", defaultImpl = WorkloadProtectableItem.class)
...
public class WorkloadProtectableItem {
    ...
    /**
     * Get type of backup management to backup an item.
     *
    ...
    /**
     * Set type of backup management to backup an item.
     *
